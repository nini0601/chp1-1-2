...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[2747,1269,1314,740],[7346,1771,512,512],[2747,0,2193,1267],[0,0,2745,1956],[8003,2803,168,50],[7759,2437,200,100],[6144,1202,1200,1200],[4942,1138,1200,1200],[4565,1913,239,198],[7981,2855,168,50],[6544,0,1200,1200],[2456,2700,168,50],[4565,2113,300,100],[3248,2753,500,500],[2510,3757,500,500],[7584,3130,500,500],[7264,3632,500,500],[7746,804,360,360],[4577,1269,360,360],[7915,1166,250,250],[7915,1418,250,250],[0,3884,500,500],[6580,3130,500,500],[2246,3255,500,500],[1004,3579,500,500],[3750,3082,500,500],[502,3884,500,500],[0,3382,500,500],[7346,1202,567,567],[4252,3082,500,500],[3250,3584,500,500],[4756,3648,500,500],[502,3382,500,500],[7860,2012,300,100],[4063,1269,512,512],[5256,3146,500,500],[1744,3134,210,50],[3752,3584,500,500],[1506,3757,500,500],[4254,3584,500,500],[7915,1670,250,50],[4754,3082,500,500],[6260,3632,500,500],[6762,3632,500,500],[5758,3146,500,500],[5258,3648,500,500],[7082,3130,500,500],[2244,2700,210,50],[2008,3757,500,500],[1242,3077,500,500],[7860,2114,300,100],[1744,3255,500,500],[2748,3255,500,500],[4063,1783,500,500],[2244,2753,500,500],[2746,2753,500,500],[3514,4086,500,500],[2510,4761,500,500],[6024,4636,500,500],[5522,4636,500,500],[7746,0,400,400],[7746,402,400,400],[2510,4259,500,500],[502,4386,500,500],[6764,4134,500,500],[7346,2285,300,100],[3012,4086,500,500],[1956,3134,210,50],[6580,2404,1177,724],[4577,1631,280,280],[2008,4761,500,500],[7028,4636,500,500],[1242,2700,1000,375],[4518,4150,500,500],[7860,1771,280,239],[4942,0,1600,1136],[502,4888,500,500],[1004,4081,500,500],[3012,4588,500,500],[0,4386,500,500],[4016,4086,500,500],[4270,2285,250,50],[5760,4134,500,500],[7981,2907,168,50],[1004,4583,500,500],[3750,2875,168,50],[4565,2215,300,100],[5020,4150,500,500],[7266,4134,500,500],[3514,4588,500,500],[2008,4259,500,500],[1506,4761,500,500],[6526,4636,500,500],[6262,4134,500,500],[4016,4588,500,500],[0,4888,500,500],[1506,4259,500,500],[7530,4636,500,500],[4518,4652,500,500],[5020,4652,500,500],[1316,1958,1314,740],[3948,2340,1314,740],[2632,2011,1314,740],[5264,2404,1314,740],[0,1958,1314,740],[8108,1050,50,50],[8108,1102,50,50],[5908,2340,220,55],[8108,886,80,80],[4806,1913,120,120],[8041,2437,120,120],[8041,2559,120,120],[8108,804,80,80],[8041,2681,120,120],[7759,2710,120,120],[7881,2710,120,120],[7759,2832,220,55],[7759,2889,220,55],[7759,3060,220,55],[1744,3077,220,55],[1966,3077,220,55],[7759,2539,280,55],[7759,3003,220,55],[7759,2946,220,55],[7759,2596,280,55],[5586,2340,320,50],[6144,1138,320,50],[5264,2340,320,50],[7860,2216,320,50],[3948,2285,320,50],[7759,2653,280,55],[0,2700,1240,680],[7759,2285,400,150],[6260,3146,210,50],[8108,968,80,80],[3750,2753,120,120]]}
];
...
(lib.luxgen_1 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.instance = new lib.luxgen();
	this.instance.parent = this;
	this.instance.setTransform(-119.5,-99);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.luxgen_1, new cjs.Rectangle(-119.5,-99,239,198), null);
...
(lib.nissan = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.instance = new lib.U117動畫物件nissan();
	this.instance.parent = this;
	this.instance.setTransform(-51,-119);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.nissan, new cjs.Rectangle(-51,-119,280,239), null);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_2623 = function() {
		...
		*/
		...
		this.chp1.addEventListener("click", fl_ClickToGoToWebPage_4);
	...
	this.frame_2634 = function() {
		...
		*/
		...
		function fl_ClickToGoToWebPage_16() {
			window.open("https://nini0601.github.io/chp2/", "_self");
		}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(19).call(this.frame_19).wait(60).call(this.frame_79).wait(8).call(this.frame_87).wait(29).call(this.frame_116).wait(527).call(this.frame_643).wait(22).call(this.frame_665).wait(518).call(this.frame_1183).wait(24).call(this.frame_1207).wait(381).call(this.frame_1588).wait(24).call(this.frame_1612).wait(726).call(this.frame_2338).wait(25).call(this.frame_2363).wait(260).call(this.frame_2623).wait(11).call(this.frame_2634).wait(1));
	...
	this.chp1 = new lib.back();
	this.chp1.parent = this;
	this.chp1.setTransform(1823.8,986.7,0.378,0.378,0,0,0,0,1.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.home},{t:this.hint},{t:this.local}]},19).to({state:[{t:this.home},{t:this.hint},{t:this.local}]},34).to({state:[{t:this.home},{t:this.hint},{t:this.local}]},26).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.home},{t:this.hint},{t:this.local}]},8).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.home},{t:this.hint},{t:this.local}]},555).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.home},{t:this.hint},{t:this.local}]},539).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.home},{t:this.local},{t:this.hint}]},404).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.home},{t:this.hint},{t:this.local}]},749).to({state:[{t:this.home},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.one},{t:this.two},{t:this.three},{t:this.four},{t:this.five},{t:this.chp1},{t:this.home},{t:this.local},{t:this.hint}]},284).to({state:[]},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.xxx).wait(79).to({_off:false},0).to({_off:true},1).wait(2555));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(53).to({_off:false},0).to({scaleX:1.45,scaleY:1.45,x:959.5,y:544.2},7).wait(20).to({scaleX:0.24,scaleY:0.24,x:1583,y:230.7},6).to({_off:true},1).wait(2548));
	...
	this.timeline.addTween(cjs.Tween.get(this.e04).wait(2634).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.chp2},{t:this.chp3},{t:this.chp11},{t:this.chp12},{t:this.chp21},{t:this.chp22},{t:this.chp111},{t:this.chp31},{t:this.chp32},{t:this.chp33},{t:this.chp34},{t:this.chp35},{t:this.chp121},{t:this.chp122},{t:this.chp1_1}]},2634).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.chp2_1},{t:this.chp3_1},{t:this.chp11_1},{t:this.chp12_1},{t:this.chp21_1},{t:this.chp22_1},{t:this.chp111_1},{t:this.chp112},{t:this.chp31_1},{t:this.chp32_1},{t:this.chp33_1},{t:this.chp34_1},{t:this.chp35_1},{t:this.chp121_1},{t:this.chp122_1},{t:this.chp1_2}]},2629).to({state:[{t:this.chp112}]},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4},{t:this.instance_3}]},2629).to({state:[{t:this.instance_4},{t:this.instance_3}]},5).wait(1));

	// 1953
	this.instance_5 = new lib._1953();
	this.instance_5.parent = this;
	this.instance_5.setTransform(172.3,911.7,1.024,1.025,0,0,0,0.1,0.1);
	this.instance_5._off = true;
	new cjs.ButtonHelper(this.instance_5, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(24).to({_off:false},0).to({regY:0.2,scaleX:0.73,scaleY:0.73,x:172.4,y:911.9},5).wait(613).to({_off:true},1).wait(1).to({_off:false},0).wait(538).to({_off:true},1).wait(1).to({_off:false},0).wait(403).to({_off:true},1).wait(1).to({_off:false},0).wait(748).to({_off:true},1).wait(1).to({_off:false},0).wait(283).to({_off:true},1).wait(12));

	// 1981
	this.instance_6 = new lib._1981();
	this.instance_6.parent = this;
	this.instance_6.setTransform(172.4,682.2,1.024,1.024,0,0,0,0.1,0.1);
	this.instance_6._off = true;
	new cjs.ButtonHelper(this.instance_6, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(29).to({_off:false},0).to({scaleX:0.73,scaleY:0.73,y:682.1},5).wait(608).to({_off:true},1).wait(1).to({_off:false},0).wait(538).to({_off:true},1).wait(1).to({_off:false},0).wait(403).to({_off:true},1).wait(1).to({_off:false},0).wait(748).to({_off:true},1).wait(1).to({_off:false},0).wait(283).to({_off:true},1).wait(12));

	// 1986
	this.instance_7 = new lib._1986();
	this.instance_7.parent = this;
	this.instance_7.setTransform(172.4,597.2,1.024,1.024,0,0,0,0.1,0.1);
	this.instance_7._off = true;
	new cjs.ButtonHelper(this.instance_7, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(34).to({_off:false},0).to({scaleX:0.73,scaleY:0.73},5).wait(603).to({_off:true},1).wait(1).to({_off:false},0).wait(538).to({_off:true},1).wait(1).to({_off:false},0).wait(403).to({_off:true},1).wait(1).to({_off:false},0).wait(748).to({_off:true},1).wait(1).to({_off:false},0).wait(283).to({_off:true},1).wait(12));

	// 1995
	this.instance_8 = new lib._1995();
	this.instance_8.parent = this;
	this.instance_8.setTransform(172.4,414.7,1.024,1.024,0,0,0,0.1,0.1);
	this.instance_8._off = true;
	new cjs.ButtonHelper(this.instance_8, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(39).to({_off:false},0).to({scaleX:0.73,scaleY:0.73,y:414.6},5).wait(598).to({_off:true},1).wait(1).to({_off:false},0).wait(538).to({_off:true},1).wait(1).to({_off:false},0).wait(403).to({_off:true},1).wait(1).to({_off:false},0).wait(748).to({_off:true},1).wait(1).to({_off:false},0).wait(283).to({_off:true},1).wait(12));

	// 2009
	this.instance_9 = new lib._2009();
	this.instance_9.parent = this;
	this.instance_9.setTransform(172.4,273,1.024,1.024,0,0,0,0.1,0.1);
	this.instance_9._off = true;
	new cjs.ButtonHelper(this.instance_9, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(44).to({_off:false},0).to({scaleX:0.73,scaleY:0.73},5).wait(593).to({_off:true},1).wait(1).to({_off:false},0).wait(538).to({_off:true},1).wait(1).to({_off:false},0).wait(403).to({_off:true},1).wait(1).to({_off:false},0).wait(748).to({_off:true},1).wait(1).to({_off:false},0).wait(283).to({_off:true},1).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.start).wait(87).to({_off:false},0).to({_off:true},1).wait(2547));

	// 發動機救國
	this.instance_10 = new lib.發();
	this.instance_10.parent = this;
	this.instance_10.setTransform(663.7,325.8,1.686,1.686,0,0,0,0.6,0.6);

	this.instance_11 = new lib.動();
	this.instance_11.parent = this;
	this.instance_11.setTransform(884.9,325.7,1.686,1.686,0,0,0,0.6,0.6);

	this.instance_12 = new lib.機();
	this.instance_12.parent = this;
	this.instance_12.setTransform(1109.1,325.7,1.686,1.686,0,0,0,0.6,0.6);

	this.instance_13 = new lib.救();
	this.instance_13.parent = this;
	this.instance_13.setTransform(1330.3,325.7,1.686,1.686,0,0,0,0.6,0.6);

	this.instance_14 = new lib.國();
	this.instance_14.parent = this;
	this.instance_14.setTransform(1551.5,325.7,1.686,1.686,0,0,0,0.6,0.6);

	this.instance_15 = new lib.補間動畫13("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(1107.4,325.5,1.463,1.463);
	this.instance_15._off = true;

	this.instance_16 = new lib.補間動畫14("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(1107.4,325.5,1.463,1.463);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_10,p:{scaleX:1.686,scaleY:1.686,x:663.7,y:325.8}}]},212).to({state:[{t:this.instance_10,p:{scaleX:1.37,scaleY:1.37,x:663.6,y:325.6}},{t:this.instance_11,p:{regX:0.6,scaleX:1.686,scaleY:1.686,x:884.9,y:325.7}}]},5).to({state:[{t:this.instance_10,p:{scaleX:1.37,scaleY:1.37,x:663.6,y:325.6}},{t:this.instance_11,p:{regX:0.5,scaleX:1.37,scaleY:1.37,x:884.6,y:325.6}},{t:this.instance_12,p:{scaleX:1.686,scaleY:1.686,x:1109.1,y:325.7}}]},5).to({state:[{t:this.instance_10,p:{scaleX:1.37,scaleY:1.37,x:663.6,y:325.6}},{t:this.instance_11,p:{regX:0.5,scaleX:1.37,scaleY:1.37,x:884.6,y:325.6}},{t:this.instance_12,p:{scaleX:1.37,scaleY:1.37,x:1108.9,y:325.6}},{t:this.instance_13,p:{scaleX:1.686,scaleY:1.686,x:1330.3,y:325.7}}]},5).to({state:[{t:this.instance_10,p:{scaleX:1.37,scaleY:1.37,x:663.6,y:325.6}},{t:this.instance_11,p:{regX:0.5,scaleX:1.37,scaleY:1.37,x:884.6,y:325.6}},{t:this.instance_12,p:{scaleX:1.37,scaleY:1.37,x:1108.9,y:325.6}},{t:this.instance_13,p:{scaleX:1.37,scaleY:1.37,x:1330.1,y:325.6}},{t:this.instance_14,p:{scaleX:1.686,scaleY:1.686,x:1551.5,y:325.7}}]},5).to({state:[{t:this.instance_10,p:{scaleX:1.37,scaleY:1.37,x:663.6,y:325.6}},{t:this.instance_11,p:{regX:0.5,scaleX:1.37,scaleY:1.37,x:884.6,y:325.6}},{t:this.instance_12,p:{scaleX:1.37,scaleY:1.37,x:1108.9,y:325.6}},{t:this.instance_13,p:{scaleX:1.37,scaleY:1.37,x:1330.1,y:325.6}},{t:this.instance_14,p:{scaleX:1.37,scaleY:1.37,x:1551.3,y:325.6}}]},5).to({state:[{t:this.instance_15}]},26).to({state:[{t:this.instance_16}]},5).to({state:[]},1).wait(2366));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(263).to({_off:false},0).to({_off:true},5).wait(2367));

	// 蔣公
	this.instance_17 = new lib.giang();
	this.instance_17.parent = this;
	this.instance_17.setTransform(1101.4,789.8,1.061,1.061,0,0,0,0.6,0.6);
	this.instance_17.alpha = 0.5;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(171).to({_off:false},0).to({y:705.1,alpha:1},32).wait(60).to({alpha:0},5).to({_off:true},1).wait(2366));

	// 咖
	this.instance_18 = new lib.卡();
	this.instance_18.parent = this;
	this.instance_18.setTransform(1095.7,841.8,1.659,1.659,0,0,0,0.6,0.1);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(238).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(2372));

	// 啦
	this.instance_19 = new lib.拉();
	this.instance_19.parent = this;
	this.instance_19.setTransform(1095.7,841.8,1.659,1.659,0,0,0,0.6,0.1);
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(243).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({alpha:0},5).to({_off:true},1).wait(2366));

	// 帽子
	this.instance_20 = new lib.帽子();
	this.instance_20.parent = this;
	this.instance_20.setTransform(1412.6,225,0.413,0.413,0,0,0,0.8,0.3);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(296).to({_off:false},0).to({regY:0.5,y:345,alpha:1},20).wait(134).to({regX:1.5,regY:0.4,scaleX:0.14,scaleY:0.14,x:1555.6,y:774.4},11).to({regX:1.2,regY:1.2,scaleX:0.09,scaleY:0.09,x:1608.3,y:842.2,alpha:0},17).to({_off:true},1).wait(2156));

	// 車走
	this.instance_21 = new lib.cargo_1();
	this.instance_21.parent = this;
	this.instance_21.setTransform(572.2,905.8,1.268,1.268,0,0,0,0.6,0.6);
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(411).to({_off:false},0).to({x:1218.2},41).to({x:1389.2},9).to({x:1617.2},12).to({alpha:0},5).to({_off:true},1).wait(2156));

	// 創辦人
	this.instance_22 = new lib.創辦人();
	this.instance_22.parent = this;
	this.instance_22.setTransform(1388.3,450.9,1.27,1.27,0,0,0,0.6,0.1);
	this.instance_22.alpha = 0;
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(269).to({_off:false},0).to({y:645.9,alpha:1},30).wait(151).to({regX:0.5,regY:0.3,scaleX:0.43,scaleY:0.43,x:1547.5,y:875.2},11).to({regX:0.8,regY:0,scaleX:0.26,scaleY:0.26,x:1603.3,y:904.3,alpha:0},12).wait(5).to({_off:true},1).wait(2156));

	// 裕隆
	this.instance_23 = new lib.裕隆();
	this.instance_23.parent = this;
	this.instance_23.setTransform(788.2,408.8,1.13,1.13,0,0,0,0.6,0.6);
	this.instance_23.alpha = 0;
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(327).to({_off:false},0).to({y:676.8,alpha:1},66).wait(32).to({x:1110.7},22).to({regX:1.1,regY:1.1,scaleX:0.22,scaleY:0.22,x:1496.9,y:837.6},14).to({regX:0.7,regY:0.7,scaleX:0.21,scaleY:0.21,x:1607.1,y:923.9,alpha:0},17).to({_off:true},1).wait(2156));

	// 車1
	this.instance_24 = new lib.車1();
	this.instance_24.parent = this;
	this.instance_24.setTransform(1019.3,338.3,1.347,1.347,0,0,0,0.5,0.5);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(479).to({_off:false},0).to({regY:0.6,y:872.7},14).wait(35).to({y:1288.6,alpha:0},25).to({_off:true},1).wait(2081));

	// 車2
	this.instance_25 = new lib.車2();
	this.instance_25.parent = this;
	this.instance_25.setTransform(1022.7,319.4,1.347,1.347,0,0,0,0.5,0.5);
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(485).to({_off:false},0).to({y:660},15).wait(28).to({regY:0.6,y:1076,alpha:0},25).to({_off:true},1).wait(2081));

	// 車3
	this.instance_26 = new lib.車3();
	this.instance_26.parent = this;
	this.instance_26.setTransform(1039.7,326.4,1.347,1.347,0,0,0,0.6,0.5);
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(492).to({_off:false},0).to({regY:0.6,y:455.6},14).wait(22).to({regY:0.5,y:871.4,alpha:0},25).to({_off:true},1).wait(2081));

	// flag
	this.instance_27 = new lib.旗子();
	this.instance_27.parent = this;
	this.instance_27.setTransform(1370.1,276,0.771,0.771,0,0,0,0.8,0.6);
	this.instance_27.alpha = 0;
	this.instance_27._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(509).to({_off:false},0).to({y:408.7,alpha:1},6).wait(13).to({y:824.6,alpha:0},25).to({_off:true},1).wait(2081));

	// endword
	this.instance_28 = new lib.endword();
	this.instance_28.parent = this;
	this.instance_28.setTransform(1105.3,603.8,0.854,0.854,0,0,0,0.7,0.7);
	this.instance_28.alpha = 0;
	this.instance_28._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(628).to({_off:false},0).to({regX:0.5,regY:0.5,scaleX:3.1,scaleY:3.1,x:1105.2,y:603.7,alpha:1},15).to({_off:true},1).wait(1991));

	// end
	this.instance_29 = new lib.暗幕();
	this.instance_29.parent = this;
	this.instance_29.setTransform(1105.4,603.7,3.174,3.571,0,0,0,0.6,0.5);
	this.instance_29.alpha = 0;
	this.instance_29._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(628).to({_off:false},0).to({alpha:0.609},15).to({_off:true},1).wait(1991));

	// 鐵砧
	this.instance_30 = new lib.樁();
	this.instance_30.parent = this;
	this.instance_30.setTransform(1078.8,1009.4,0.233,0.233,0,0,0,0.7,0.8);
	this.instance_30.alpha = 0;
	this.instance_30._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(568).to({_off:false},0).to({regY:0.7,y:848.4,alpha:1},15).wait(41).to({alpha:0.609},19).to({_off:true},1).wait(1991));

	// 煙m
	this.instance_31 = new lib.煙M();
	this.instance_31.parent = this;
	this.instance_31.setTransform(1102,692.3,0.906,0.906,0,0,0,5.4,0.5);
	this.instance_31._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(613).to({_off:false},0).to({regY:0.6,scaleX:2.19,scaleY:2.19,x:1134.3,y:527.2},11).to({alpha:0.609},19).to({_off:true},1).wait(1991));

	// 煙L
	this.instance_32 = new lib.煙L();
	this.instance_32.parent = this;
	this.instance_32.setTransform(964.9,704.6,0.235,0.239,0,0,0,0.7,1.1);
	this.instance_32._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(613).to({_off:false},0).to({regX:0.8,regY:0.8,scaleX:0.46,scaleY:0.47,x:846,y:590.5},11).to({alpha:0.609},19).to({_off:true},1).wait(1991));

	// 煙R
	this.instance_33 = new lib.煙R();
	this.instance_33.parent = this;
	this.instance_33.setTransform(1241.8,696.7,0.226,0.226,0,0,0,0.9,0.9);
	this.instance_33._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(613).to({_off:false},0).to({regX:0.7,regY:0.8,scaleX:0.44,scaleY:0.44,x:1387.9,y:609.7},11).to({alpha:0.609},19).to({_off:true},1).wait(1991));

	// 槌1
	this.instance_34 = new lib.槌左1();
	this.instance_34.parent = this;
	this.instance_34.setTransform(559.7,507,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_34.alpha = 0;
	this.instance_34._off = true;

	this.instance_35 = new lib.槌左2();
	this.instance_35.parent = this;
	this.instance_35.setTransform(909.6,539.5,1.463,1.463,0,0,0,0.5,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_34}]},554).to({state:[{t:this.instance_34}]},29).to({state:[{t:this.instance_35}]},5).to({state:[{t:this.instance_34}]},10).to({state:[{t:this.instance_35}]},10).to({state:[{t:this.instance_34}]},10).to({state:[{t:this.instance_35}]},6).to({state:[]},1).wait(2010));
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(554).to({_off:false},0).to({x:740.5,y:501.1,alpha:1},29).to({_off:true},5).wait(10).to({_off:false},0).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},6).wait(2011));

	// 槌2
	this.instance_36 = new lib.槌右1();
	this.instance_36.parent = this;
	this.instance_36.setTransform(1610,597.8,1.463,1.463,0,0,0,0.5,0.6);
	this.instance_36.alpha = 0;
	this.instance_36._off = true;

	this.instance_37 = new lib.槌右2();
	this.instance_37.parent = this;
	this.instance_37.setTransform(1306.2,574.4,1.463,1.463,0,0,0,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_36}]},564).to({state:[{t:this.instance_36}]},19).to({state:[{t:this.instance_36}]},5).to({state:[{t:this.instance_37}]},10).to({state:[{t:this.instance_36}]},10).to({state:[{t:this.instance_37}]},10).to({state:[{t:this.instance_36}]},6).to({state:[]},1).wait(2010));
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(564).to({_off:false},0).to({x:1408.1,alpha:1},19).wait(5).to({_off:true},10).wait(10).to({_off:false},0).to({_off:true},10).wait(6).to({_off:false},0).to({_off:true},1).wait(2010));

	// 1953
	this.instance_38 = new lib._1953Y();
	this.instance_38.parent = this;
	this.instance_38.setTransform(1103.7,343,0.872,0.872,0,0,0,0.7,0.7);
	this.instance_38._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_38).wait(104).to({_off:false},0).to({y:424.9},14).wait(36).to({y:339.9,alpha:0},30).to({_off:true},1).wait(2450));

	// bg1
	this.instance_39 = new lib.bg1();
	this.instance_39.parent = this;
	this.instance_39.setTransform(961.6,542.9,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_39.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_39).to({alpha:1},24).wait(619).to({_off:true},1).wait(1991));

	// endword
	this.instance_40 = new lib.endword();
	this.instance_40.parent = this;
	this.instance_40.setTransform(1105.3,603.8,0.854,0.854,0,0,0,0.7,0.7);
	this.instance_40.alpha = 0;
	this.instance_40._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(1173).to({_off:false},0).to({regX:0.5,regY:0.5,scaleX:3.1,scaleY:3.1,x:1105.2,y:603.7,alpha:1},10).to({_off:true},1).wait(1451));

	// end
	this.instance_41 = new lib.暗幕();
	this.instance_41.parent = this;
	this.instance_41.setTransform(1105.4,603.7,3.174,3.571,0,0,0,0.6,0.5);
	this.instance_41.alpha = 0;
	this.instance_41._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_41).wait(1173).to({_off:false},0).to({alpha:0.609},10).to({_off:true},1).wait(1451));

	// word
	this.instance_42 = new lib.word();
	this.instance_42.parent = this;
	this.instance_42.setTransform(1082.3,320.9,1.078,1.078,0,0,0,0.1,0.7);
	this.instance_42.alpha = 0;
	this.instance_42._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_42).wait(1148).to({_off:false},0).to({y:368.2,alpha:1},15).wait(9).to({_off:true},1).wait(1462));

	// hat5
	this.instance_43 = new lib.hat();
	this.instance_43.parent = this;
	this.instance_43.setTransform(1519.5,394.2,0.337,0.337,0,0,0,0.8,0.8);
	this.instance_43.alpha = 0;
	this.instance_43._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_43).wait(1148).to({_off:false},0).to({y:506.2,alpha:1},15).wait(20).to({_off:true},1).wait(1451));

	// man5
	this.instance_44 = new lib.strongman();
	this.instance_44.parent = this;
	this.instance_44.setTransform(1522.1,916.3,0.732,0.732,0,0,0,0.6,0.6);
	this.instance_44.alpha = 0;
	this.instance_44._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_44).wait(1136).to({_off:false},0).to({y:692.4,alpha:1},17).wait(20).to({alpha:0.609},10).to({_off:true},1).wait(1451));

	// hat4
	this.instance_45 = new lib.hat();
	this.instance_45.parent = this;
	this.instance_45.setTransform(1226.8,394.2,0.337,0.337,0,0,0,0.6,0.8);
	this.instance_45.alpha = 0;
	this.instance_45._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_45).wait(1148).to({_off:false},0).to({y:506.2,alpha:1},15).wait(20).to({_off:true},1).wait(1451));

	// man4
	this.instance_46 = new lib.strongman();
	this.instance_46.parent = this;
	this.instance_46.setTransform(1229.9,916.3,0.732,0.732,0,0,0,0.6,0.6);
	this.instance_46.alpha = 0;
	this.instance_46._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_46).wait(1136).to({_off:false},0).to({y:692.4,alpha:1},17).wait(20).to({alpha:0.609},10).to({_off:true},1).wait(1451));

	// hat3
	this.instance_47 = new lib.hat();
	this.instance_47.parent = this;
	this.instance_47.setTransform(942.9,394.2,0.337,0.337,0,0,0,0.8,0.8);
	this.instance_47.alpha = 0;
	this.instance_47._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_47).wait(1148).to({_off:false},0).to({y:506.2,alpha:1},15).wait(20).to({_off:true},1).wait(1451));

	// man3
	this.instance_48 = new lib.strongman();
	this.instance_48.parent = this;
	this.instance_48.setTransform(944.9,916.3,0.732,0.732,0,0,0,0.6,0.6);
	this.instance_48.alpha = 0;
	this.instance_48._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_48).wait(1136).to({_off:false},0).to({y:692.4,alpha:1},17).wait(20).to({alpha:0.609},10).to({_off:true},1).wait(1451));

	// hat2
	this.instance_49 = new lib.hat();
	this.instance_49.parent = this;
	this.instance_49.setTransform(666.3,394.2,0.337,0.337,0,0,0,0.6,0.8);
	this.instance_49.alpha = 0;
	this.instance_49._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_49).wait(1148).to({_off:false},0).to({y:506.2,alpha:1},15).wait(20).to({_off:true},1).wait(1451));

	// man2
	this.instance_50 = new lib.strongman();
	this.instance_50.parent = this;
	this.instance_50.setTransform(669.2,916.3,0.732,0.732,0,0,0,0.6,0.6);
	this.instance_50.alpha = 0;
	this.instance_50._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_50).wait(1136).to({_off:false},0).to({y:692.4,alpha:1},17).wait(20).to({alpha:0.609},10).to({_off:true},1).wait(1451));

	// factory
	this.instance_51 = new lib.factory();
	this.instance_51.parent = this;
	this.instance_51.setTransform(1095.9,407.4,1.463,1.463,0,0,0,0.6,0.1);
	this.instance_51.alpha = 0;
	this.instance_51._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_51).wait(1048).to({_off:false},0).to({y:605,alpha:1},20).wait(50).to({alpha:0},20).to({_off:true},1).wait(1496));

	// man
	this.instance_52 = new lib.man();
	this.instance_52.parent = this;
	this.instance_52.setTransform(669.5,755.4,1.463,1.463,0,0,0,-291.8,102.1);
	this.instance_52._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_52).wait(1068).to({_off:false},0).wait(50).to({alpha:0},10).to({_off:true},1).wait(1506));

	// 設備
	this.instance_53 = new lib.thing();
	this.instance_53.parent = this;
	this.instance_53.setTransform(1103,481.3,0.702,0.702,0,0,0,0.7,0.1);
	this.instance_53.alpha = 0;
	this.instance_53._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_53).wait(1008).to({_off:false},0).to({y:593.3,alpha:1},20).to({x:892.3,alpha:0},25).to({_off:true},1).wait(1581));

	// 錢
	this.instance_54 = new lib.money();
	this.instance_54.parent = this;
	this.instance_54.setTransform(920.4,601.9,0.817,0.817,0,0,0,0.7,0.1);
	this.instance_54.alpha = 0;
	this.instance_54._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_54).wait(954).to({_off:false},0).to({regX:0.8,x:1131.1,alpha:1},34).to({y:466.9,alpha:0},20).to({_off:true},1).wait(1626));

	// 工具
	this.instance_55 = new lib.tool();
	this.instance_55.parent = this;
	this.instance_55.setTransform(1105,498.3,0.702,0.702,0,0,0,0.7,0.6);
	this.instance_55.alpha = 0;
	this.instance_55._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_55).wait(908).to({_off:false},0).to({y:594.9,alpha:1},20).to({x:952.8,alpha:0},25).to({_off:true},1).wait(1681));

	// 手
	this.instance_56 = new lib.hand();
	this.instance_56.parent = this;
	this.instance_56.setTransform(733.9,778.4,1.813,1.813,0,0,0,0.5,0.5);
	this.instance_56.alpha = 0;
	this.instance_56._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_56).wait(885).to({_off:false},0).to({x:924.2,alpha:1},23).wait(20).to({x:745.6,alpha:0},25).wait(1).to({x:924.2,alpha:1},34).wait(40).to({x:745.6,alpha:0},25).to({_off:true},1).wait(1581));

	// 工程
	this.instance_57 = new lib.桃地();
	this.instance_57.parent = this;
	this.instance_57.setTransform(918.2,218.8,0.585,0.585,0,0,0,0.6,0.7);
	this.instance_57.alpha = 0;
	this.instance_57._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_57).wait(837).to({_off:false},0).to({y:327.1,alpha:1},21).wait(15).to({regX:0.5,x:1181.6,alpha:0},20).to({_off:true},1).wait(1741));

	// 桃園
	this.instance_58 = new lib.tao_1();
	this.instance_58.parent = this;
	this.instance_58.setTransform(917.6,501.7,1.829,1.828,0,0,0,0.6,0.6);
	this.instance_58.alpha = 0;
	this.instance_58._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_58).wait(808).to({_off:false},0).to({alpha:1},15).wait(50).to({regX:0.7,x:1181.2,alpha:0},20).to({_off:true},1).wait(1741));

	// red
	this.instance_59 = new lib.RC();
	this.instance_59.parent = this;
	this.instance_59.setTransform(1137.1,583.1,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_59.alpha = 0;
	this.instance_59._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_59).wait(798).to({_off:false},0).to({alpha:1},25).wait(50).to({x:1400.5,alpha:0},20).to({_off:true},1).wait(1741));

	// 工廠
	this.instance_60 = new lib.苗地();
	this.instance_60.parent = this;
	this.instance_60.setTransform(728.6,505.3,0.636,0.636,0,0,0,0.7,0.7);
	this.instance_60.alpha = 0;
	this.instance_60._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_60).wait(776).to({_off:false},0).to({regY:0.6,y:593.1,alpha:1},22).wait(75).to({x:992,alpha:0},20).to({_off:true},1).wait(1741));

	// 苗栗
	this.instance_61 = new lib.miao_1();
	this.instance_61.parent = this;
	this.instance_61.setTransform(732.2,782.7,1.742,1.742,0,0,0,0.5,0.5);
	this.instance_61.alpha = 0;
	this.instance_61._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_61).wait(749).to({_off:false},0).to({alpha:1},14).wait(110).to({x:995.6,alpha:0},20).to({_off:true},1).wait(1741));

	// red
	this.instance_62 = new lib.RC();
	this.instance_62.parent = this;
	this.instance_62.setTransform(1000.3,815.7,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_62.alpha = 0;
	this.instance_62._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_62).wait(739).to({_off:false},0).to({alpha:1},24).wait(110).to({regX:0,regY:0,x:999.4,y:814.8},0).to({x:1262.8,alpha:0},20).to({_off:true},1).wait(1741));

	// 台灣
	this.instance_63 = new lib.taiwan_1();
	this.instance_63.parent = this;
	this.instance_63.setTransform(1114.1,898.6,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_63.alpha = 0;
	this.instance_63._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_63).wait(714).to({_off:false},0).to({regY:0.5,y:628.6,alpha:1},25).wait(134).to({x:1377.5,alpha:0},20).to({_off:true},1).wait(1741));

	// 1981
	this.instance_64 = new lib._1981Y();
	this.instance_64.parent = this;
	this.instance_64.setTransform(1103.7,343,0.872,0.872,0,0,0,0.7,0.7);
	this.instance_64._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_64).wait(653).to({_off:false},0).to({regY:0.6,y:427.9},13).wait(36).to({regY:0.7,y:343,alpha:0},31).to({_off:true},1).wait(1901));

	// bg2
	this.instance_65 = new lib.bg2();
	this.instance_65.parent = this;
	this.instance_65.setTransform(961.6,541.6,1.463,1.463,0,0,0,0.6,0.6);
	this.instance_65._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_65).wait(644).to({_off:false},0).wait(539).to({_off:true},1).wait(1451));

	// endword
	this.instance_66 = new lib.endword();
	this.instance_66.parent = this;
	this.instance_66.setTransform(1105.3,603.8,0.854,0.854,0,0,0,0.7,0.7);
	this.instance_66.alpha = 0;
	this.instance_66._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_66).wait(1573).to({_off:false},0).to({regX:0.5,regY:0.5,scaleX:3.1,scaleY:3.1,x:1105.2,y:603.7,alpha:1},15).to({_off:true},1).wait(1046));

	// end
	this.instance_67 = new lib.暗幕();
	this.instance_67.parent = this;
	this.instance_67.setTransform(1105.4,603.7,3.174,3.571,0,0,0,0.6,0.5);
	this.instance_67.alpha = 0;
	this.instance_67._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_67).wait(1573).to({_off:false},0).to({alpha:0.609},15).to({_off:true},1).wait(1046));

	// 101
	this.instance_68 = new lib._101();
	this.instance_68.parent = this;
	this.instance_68.setTransform(1077.8,756.1,1.005,1.005,0,0,0,0.1,0.1);
	this.instance_68.alpha = 0;
	this.instance_68._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_68).wait(1493).to({_off:false},0).to({regX:0,regY:0,scaleX:1.9,scaleY:1.9,x:1077.7,y:736.1,alpha:1},45).wait(35).to({alpha:0.609},15).to({_off:true},1).wait(1046));

	// bling
	this.instance_69 = new lib.bling();
	this.instance_69.parent = this;
	this.instance_69.setTransform(1106,667.2,1.951,1.727);
	this.instance_69._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_69).wait(1538).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).wait(5).to({alpha:0.609},15).to({_off:true},1).wait(1046));

	// blingbling
	this.instance_70 = new lib.blingbling();
	this.instance_70.parent = this;
	this.instance_70.setTransform(1106,667.2,1.951,1.727);
	this.instance_70._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_70).wait(1543).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(1067));

	// smoke
	this.instance_71 = new lib.smoke2_1();
	this.instance_71.parent = this;
	this.instance_71.setTransform(1104.6,583,1.317,1.317,0,0,0,0.1,0.1);
	this.instance_71._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_71).wait(1433).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(1157));

	// smoke
	this.instance_72 = new lib.smoke1_1();
	this.instance_72.parent = this;
	this.instance_72.setTransform(1104.5,583,0.818,0.818,0,0,0,0.1,0.1);
	this.instance_72.alpha = 0;
	this.instance_72._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_72).wait(1413).to({_off:false},0).to({scaleX:1.32,scaleY:1.32,x:1104.6,alpha:1},15).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({regX:0,regY:0,scaleX:2,scaleY:2,x:1104.4,y:582.9},12).to({alpha:0},13).to({_off:true},1).wait(1131));

	// tire
	this.instance_73 = new lib.tool4();
	this.instance_73.parent = this;
	this.instance_73.setTransform(646.4,832,0.585,0.585,0,0,0,0.1,0.1);
	this.instance_73._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_73).wait(1465).to({_off:false},0).wait(5).to({regX:0.3,regY:0.3,scaleX:0.36,scaleY:0.36,x:646.5,y:755.1},4).to({regX:0.4,regY:0.4,scaleX:0.28,scaleY:0.28,x:1108.1,y:631.1},4).to({_off:true},1).wait(1156));

	// steeringwheel
	this.instance_74 = new lib.tool3();
	this.instance_74.parent = this;
	this.instance_74.setTransform(1580.1,842.5,0.585,0.585,0,0,0,0.1,0);
	this.instance_74._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_74).wait(1453).to({_off:false},0).wait(5).to({regY:0.3,scaleX:0.43,scaleY:0.43,x:1409.2,y:887.7},4).to({regX:0.3,scaleX:0.31,scaleY:0.31,x:1104.5,y:583},4).to({_off:true},1).wait(1168));

	// spanner
	this.instance_75 = new lib.tool2();
	this.instance_75.parent = this;
	this.instance_75.setTransform(650.1,378,0.673,0.673,0,0,0,0.1,0.1);
	this.instance_75._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_75).wait(1441).to({_off:false},0).wait(5).to({regX:0.5,regY:0.3,scaleX:0.42,scaleY:0.42,x:783.1,y:346.5},4).to({regX:0.4,regY:0.4,scaleX:0.27,scaleY:0.27,x:1094.1,y:628.6},3).to({_off:true},1).wait(1181));

	// screw
	this.instance_76 = new lib.tool1();
	this.instance_76.parent = this;
	this.instance_76.setTransform(1600.8,363.5,0.585,0.585,0,0,0,0.1,0.1);
	this.instance_76._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_76).wait(1428).to({_off:false},0).wait(5).to({regX:0.2,regY:0.2,scaleX:0.45,scaleY:0.45,x:1464.6,y:340.4},4).to({regX:0.3,regY:0.3,scaleX:0.32,scaleY:0.32,x:1170.9,y:601.2},4).to({_off:true},1).wait(1193));

	// dingdong
	this.instance_77 = new lib.ding();
	this.instance_77.parent = this;
	this.instance_77.setTransform(1391.3,425.6,0.195,0.195,0,0,0,1,0.5);
	this.instance_77.alpha = 0;
	this.instance_77._off = true;

	this.instance_78 = new lib.dong();
	this.instance_78.parent = this;
	this.instance_78.setTransform(1391.3,425.6,0.615,0.615,0,0,0,0.4,0.1);
	this.instance_78._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_77).wait(1369).to({_off:false},0).to({regX:0.4,regY:0.1,scaleX:0.62,scaleY:0.62,alpha:1},14).to({_off:true},2).wait(1250));
	this.timeline.addTween(cjs.Tween.get(this.instance_78).wait(1385).to({_off:false},0).wait(11).to({alpha:0},17).to({_off:true},1).wait(1221));

	// person2
	this.instance_79 = new lib.got();
	this.instance_79.parent = this;
	this.instance_79.setTransform(1097.6,692.4,1.142,1.142,0,0,0,0.1,0.1);
	this.instance_79.alpha = 0;
	this.instance_79._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_79).wait(1363).to({_off:false},0).to({alpha:1},13).wait(20).to({alpha:0},17).to({_off:true},1).wait(1221));

	// person
	this.instance_80 = new lib.think();
	this.instance_80.parent = this;
	this.instance_80.setTransform(1097.7,875,1.142,1.142,0,0,0,0.7,0.1);
	this.instance_80.alpha = 0;
	this.instance_80._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_80).wait(1258).to({_off:false},0).to({y:692.4,alpha:1},25).wait(80).to({alpha:0},13).to({_off:true},1).wait(1258));

	// left
	this.instance_81 = new lib.leftthink();
	this.instance_81.parent = this;
	this.instance_81.setTransform(1101.1,597.9,0.4,0.4,0,0,0,0.3,0.3);
	this.instance_81._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_81).wait(1283).to({_off:false},0).to({regX:0,regY:0,scaleX:0.73,scaleY:0.73,x:699.1,y:524.7},30).wait(40).to({alpha:0},10).to({_off:true},1).wait(1271));

	// right
	this.instance_82 = new lib.rightthink();
	this.instance_82.parent = this;
	this.instance_82.setTransform(1100.1,594.7,0.382,0.382,0,0,0,50.4,50.5);
	this.instance_82._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_82).wait(1313).to({_off:false},0).to({regX:50.1,regY:50,scaleX:0.73,scaleY:0.73,x:1474.1,y:438.2},30).wait(10).to({alpha:0},10).to({_off:true},1).wait(1271));

	// 1986
	this.instance_83 = new lib._1986Y();
	this.instance_83.parent = this;
	this.instance_83.setTransform(1103.7,343,0.872,0.872,0,0,0,0.7,0.1);
	this.instance_83._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_83).wait(1193).to({_off:false},0).to({y:420.3},15).wait(35).to({y:262.2,alpha:0},30).to({_off:true},1).wait(1361));

	// bg3
	this.instance_84 = new lib.bg3();
	this.instance_84.parent = this;
	this.instance_84.setTransform(963,541.9,1.463,1.463,0,0,0,0.5,0.1);
	this.instance_84._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_84).wait(1184).to({_off:false},0).wait(404).to({_off:true},1).wait(1046));

	// endword
	this.instance_85 = new lib.endword();
	this.instance_85.parent = this;
	this.instance_85.setTransform(1105.3,603.8,0.854,0.854,0,0,0,0.7,0.7);
	this.instance_85.alpha = 0;
	this.instance_85._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_85).wait(2323).to({_off:false},0).to({regX:0.5,regY:0.5,scaleX:3.1,scaleY:3.1,x:1105.2,y:603.7,alpha:1},15).to({_off:true},1).wait(296));

	// end
	this.instance_86 = new lib.暗幕();
	this.instance_86.parent = this;
	this.instance_86.setTransform(1105.4,603.7,3.174,3.571,0,0,0,0.6,0.5);
	this.instance_86.alpha = 0;
	this.instance_86._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_86).wait(2323).to({_off:false},0).to({alpha:0.609},15).to({_off:true},1).wait(296));

	// 柱
	this.instance_87 = new lib.柱狀圖();
	this.instance_87.parent = this;
	this.instance_87.setTransform(867.3,742.5,3.804,3.804,0,0,0,28,0);
	this.instance_87._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_87).wait(2228).to({_off:false},0).wait(110).to({_off:true},1).wait(296));

	// file
	this.instance_88 = new lib.file();
	this.instance_88.parent = this;
	this.instance_88.setTransform(1453.1,390.1,1.463,1.463,0,0,0,0.1,0.6);
	this.instance_88.alpha = 0;
	this.instance_88._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_88).wait(2173).to({_off:false},0).to({y:538,alpha:1},35).wait(5).to({alpha:0},15).to({_off:true},1).wait(406));

	// heart
	this.instance_89 = new lib.heart();
	this.instance_89.parent = this;
	this.instance_89.setTransform(1085.8,390.8,1.463,1.463,0,0,0,0.1,0.6);
	this.instance_89.alpha = 0;
	this.instance_89._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_89).wait(2143).to({_off:false},0).to({y:538.7,alpha:1},30).wait(40).to({alpha:0},15).to({_off:true},1).wait(406));

	// commu
	this.instance_90 = new lib.communication();
	this.instance_90.parent = this;
	this.instance_90.setTransform(717.3,390.1,1.463,1.463,0,0,0,0.1,0.6);
	this.instance_90.alpha = 0;
	this.instance_90._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_90).wait(2113).to({_off:false},0).to({y:538,alpha:1},30).wait(70).to({alpha:0},15).to({_off:true},1).wait(406));

	// control
	this.instance_91 = new lib.companyM();
	this.instance_91.parent = this;
	this.instance_91.setTransform(690.8,703.7,1.742,1.742,0,0,0,0.1,0.5);
	this.instance_91.alpha = 0;
	this.instance_91._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_91).wait(2063).to({_off:false},0).to({alpha:1},5).wait(30).to({y:940.8,alpha:0},15).to({_off:true},1).wait(521));

	// CTY
	this.instance_92 = new lib.companyTY();
	this.instance_92.parent = this;
	this.instance_92.setTransform(935,498.8,0.486,0.486,0,0,0,0.2,0.6);
	this.instance_92.alpha = 0;
	this.instance_92._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_92).wait(1983).to({_off:false},0).to({y:597.6,alpha:1},30).wait(10).to({x:586.5,y:852},45).wait(30).to({y:1089.1,alpha:0},15).to({_off:true},1).wait(521));

	// CSH
	this.instance_93 = new lib.companySH();
	this.instance_93.parent = this;
	this.instance_93.setTransform(1094.2,334.7,0.584,0.584,0,0,0,0.1,0.6);
	this.instance_93.alpha = 0;
	this.instance_93._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_93).wait(1943).to({_off:false},0).to({regY:0.5,y:410.4,alpha:1},30).wait(50).to({regY:0.7,x:808,y:824.2},45).wait(30).to({regY:0.6,y:1061.2,alpha:0},15).to({_off:true},1).wait(521));

	// CT
	this.instance_94 = new lib.companyT();
	this.instance_94.parent = this;
	this.instance_94.setTransform(1293.4,309,0.395,0.395,0,0,0,0.1,0.7);
	this.instance_94.alpha = 0;
	this.instance_94._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_94).wait(1898).to({_off:false},0).to({y:371.5,alpha:1},30).wait(95).to({regX:0.3,regY:0.5,x:1001.9,y:849.9},45).wait(30).to({regY:0.7,y:1087.1,alpha:0},15).to({_off:true},1).wait(521));

	// bigtaiwan
	this.instance_95 = new lib.bigtaiwan();
	this.instance_95.parent = this;
	this.instance_95.setTransform(1114.1,898.6,1.463,1.463,0,0,0,0.1,0.6);
	this.instance_95.alpha = 0;
	this.instance_95._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_95).wait(1848).to({_off:false},0).to({regY:0.5,y:628.6,alpha:1},40).wait(210).to({y:865.6,alpha:0},15).to({_off:true},1).wait(521));

	// toyota
	this.instance_96 = new lib.toyota();
	this.instance_96.parent = this;
	this.instance_96.setTransform(1694.2,664.7,0.096,0.096,0,0,0,1.1,1.1);
	this.instance_96.alpha = 0;
	this.instance_96._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_96).wait(1809).to({_off:false},0).to({regX:0.9,regY:0.7,scaleX:0.22,scaleY:0.22,x:1518.3,alpha:1},10).wait(9).to({alpha:0},20).to({_off:true},1).wait(786));

	// bmw
	this.instance_97 = new lib.bmw();
	this.instance_97.parent = this;
	this.instance_97.setTransform(1654.8,496.1,0.463,0.463,0,0,0,157.2,0.7);
	this.instance_97.alpha = 0;
	this.instance_97._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_97).wait(1798).to({_off:false},0).to({regX:157.1,regY:0.6,scaleX:0.81,scaleY:0.81,x:1485.4,y:341.9,alpha:1},11).wait(19).to({alpha:0},20).to({_off:true},1).wait(786));

	// nissan
	this.instance_98 = new lib.nissan();
	this.instance_98.parent = this;
	this.instance_98.setTransform(567.5,899.8,0.575,0.575,0,0,0,89,0.5);
	this.instance_98.alpha = 0;
	this.instance_98._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_98).wait(1788).to({_off:false},0).to({regY:0.6,scaleX:1.04,scaleY:1.04,x:746.7,y:787.9,alpha:1},10).wait(30).to({alpha:0},20).to({_off:true},1).wait(786));

	// ford
	this.instance_99 = new lib.ford();
	this.instance_99.parent = this;
	this.instance_99.setTransform(1586.4,942.8,0.137,0.137,0,0,0,0.8,1.1);
	this.instance_99.alpha = 0;
	this.instance_99._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_99).wait(1778).to({_off:false},0).to({regX:0.4,regY:0.8,scaleX:0.31,scaleY:0.31,x:1365,y:901.4,alpha:1},10).wait(40).to({alpha:0},20).to({_off:true},1).wait(786));

	// audi
	this.instance_100 = new lib.audi();
	this.instance_100.parent = this;
	this.instance_100.setTransform(609.7,321.8,0.156,0.156,0,0,0,0.7,1);
	this.instance_100.alpha = 0;
	this.instance_100._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_100).wait(1768).to({_off:false},0).to({regX:0.8,regY:0.4,scaleX:0.26,scaleY:0.26,x:847.6,y:362.3,alpha:1},10).wait(50).to({alpha:0},20).to({_off:true},1).wait(786));

	// taiwan
	this.instance_101 = new lib.taiwan();
	this.instance_101.parent = this;
	this.instance_101.setTransform(1127.4,862.8,1.463,1.463,0,0,0,0.1,0.5);
	this.instance_101.alpha = 0;
	this.instance_101._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_101).wait(1753).to({_off:false},0).to({regY:0.6,y:602.8,alpha:1},15).wait(60).to({alpha:0},20).to({_off:true},1).wait(786));

	// 手
	this.instance_102 = new lib.手();
	this.instance_102.parent = this;
	this.instance_102.setTransform(1097.5,1018,2.512,2.023);
	this.instance_102.alpha = 0;
	this.instance_102._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_102).wait(1681).to({_off:false},0).to({y:751.1,alpha:1},21).wait(41).to({alpha:0},15).to({_off:true},1).wait(876));

	// WTO
	this.instance_103 = new lib.WTO();
	this.instance_103.parent = this;
	this.instance_103.setTransform(1108,225.1,1.463,1.463);
	this.instance_103.alpha = 0;
	this.instance_103._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_103).wait(1668).to({_off:false},0).to({y:407.8,alpha:1},19).wait(56).to({alpha:0},15).to({_off:true},1).wait(876));

	// 1995
	this.instance_104 = new lib._1995Y();
	this.instance_104.parent = this;
	this.instance_104.setTransform(1103.6,343,0.872,0.872,0,0,0,0.1,0.1);
	this.instance_104._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_104).wait(1598).to({_off:false},0).to({y:420.3},15).wait(35).to({y:304.4,alpha:0},30).to({_off:true},1).wait(956));

	// bg4
	this.instance_105 = new lib.bg4();
	this.instance_105.parent = this;
	this.instance_105.setTransform(961.5,541.9,1.463,1.463,0,0,0,0.1,0.1);
	this.instance_105._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_105).wait(1589).to({_off:false},0).wait(749).to({_off:true},1).wait(296));

	// endword
	this.instance_106 = new lib.endword();
	this.instance_106.parent = this;
	this.instance_106.setTransform(1105.3,603.8,0.854,0.854,0,0,0,0.7,0.7);
	this.instance_106.alpha = 0;
	this.instance_106._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_106).wait(2608).to({_off:false},0).to({regX:0.5,regY:0.5,scaleX:3.1,scaleY:3.1,x:1105.2,y:603.7,alpha:1},15).to({_off:true},1).wait(11));

	// end
	this.instance_107 = new lib.暗幕();
	this.instance_107.parent = this;
	this.instance_107.setTransform(1105.4,603.7,3.174,3.571,0,0,0,0.6,0.5);
	this.instance_107.alpha = 0;
	this.instance_107._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_107).wait(2608).to({_off:false},0).to({alpha:0.609},15).to({_off:true},1).wait(11));

	// 標5
	this.instance_108 = new lib.標();
	this.instance_108.parent = this;
	this.instance_108.setTransform(1382.3,620.7,0.338,0.338,0,0,0,0.3,0.1);
	this.instance_108.alpha = 0;
	this.instance_108._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_108).wait(2578).to({_off:false},0).to({regY:0,y:679.1,alpha:1},5).wait(25).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// 標4
	this.instance_109 = new lib.標();
	this.instance_109.parent = this;
	this.instance_109.setTransform(1008.4,703,0.338,0.338,0,0,0,0.1,0.3);
	this.instance_109.alpha = 0;
	this.instance_109._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_109).wait(2573).to({_off:false},0).to({y:761.5,alpha:1},5).wait(30).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// 標3
	this.instance_110 = new lib.標();
	this.instance_110.parent = this;
	this.instance_110.setTransform(1293.1,257.1,0.338,0.338,0,0,0,0.1,0.3);
	this.instance_110.alpha = 0;
	this.instance_110._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_110).wait(2568).to({_off:false},0).to({y:315.6,alpha:1},5).wait(35).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// 標2
	this.instance_111 = new lib.標();
	this.instance_111.parent = this;
	this.instance_111.setTransform(1227.9,515.4,0.338,0.338,0,0,0,0.3,0);
	this.instance_111.alpha = 0;
	this.instance_111._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_111).wait(2563).to({_off:false},0).to({regY:0.6,y:574,alpha:1},5).wait(40).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// 標1
	this.instance_112 = new lib.標();
	this.instance_112.parent = this;
	this.instance_112.setTransform(912.5,346.3,0.338,0.338,0,0,0,0.3,0.3);
	this.instance_112.alpha = 0;
	this.instance_112._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_112).wait(2558).to({_off:false},0).to({regY:0.1,y:404.7,alpha:1},5).wait(45).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// earth
	this.instance_113 = new lib.earth();
	this.instance_113.parent = this;
	this.instance_113.setTransform(1145.6,975.1,1.463,1.463);
	this.instance_113.alpha = 0;
	this.instance_113._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_113).wait(2523).to({_off:false},0).to({y:613.9,alpha:1},30).wait(55).to({alpha:0.621},15).to({_off:true},1).wait(11));

	// luxgen
	this.instance_114 = new lib.luxgen_1();
	this.instance_114.parent = this;
	this.instance_114.setTransform(1101.5,571.6,1.012,1.012,0,0,0,0.1,0.1);
	this.instance_114.alpha = 0;
	this.instance_114._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_114).wait(2481).to({_off:false},0).to({regX:0,regY:0,scaleX:2.78,scaleY:2.78,x:1101.4,y:571.5,alpha:1},22).wait(10).to({alpha:0},15).to({_off:true},1).wait(106));

	// smoke
	this.instance_115 = new lib.smoke2();
	this.instance_115.parent = this;
	this.instance_115.setTransform(1104.6,583,1.317,1.317,0,0,0,0.1,0.1);
	this.instance_115._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_115).wait(2435).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},4).wait(4).to({_off:false},0).to({scaleX:0.73,scaleY:0.73,x:1104.5,y:582.9,alpha:0},15).to({_off:true},1).wait(146));

	// smoke
	this.instance_116 = new lib.smoke1();
	this.instance_116.parent = this;
	this.instance_116.setTransform(1104.5,583,0.768,0.768,0,0,0,0.1,0.1);
	this.instance_116.alpha = 0;
	this.instance_116._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_116).wait(2415).to({_off:false},0).to({scaleX:1.32,scaleY:1.32,x:1104.6,alpha:1},15).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(5).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},4).wait(162));

	// 1
	this.instance_117 = new lib._1();
	this.instance_117.parent = this;
	this.instance_117.setTransform(1359.5,296.4,0.352,0.352,0,0,0,0.1,0.1);
	this.instance_117.alpha = 0;
	this.instance_117._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_117).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:1,regY:2,scaleX:0.1,scaleY:0.1,x:1211.6,y:514.4},30).to({_off:true},1).wait(166));

	// 2
	this.instance_118 = new lib._2();
	this.instance_118.parent = this;
	this.instance_118.setTransform(844.1,299.4,0.421,0.421,0,0,0,0.3,0.5);
	this.instance_118.alpha = 0;
	this.instance_118._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_118).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:0.8,regY:0.4,scaleX:0.12,scaleY:0.12,x:1067.5,y:515.2},30).to({_off:true},1).wait(166));

	// 3
	this.instance_119 = new lib._3();
	this.instance_119.parent = this;
	this.instance_119.setTransform(682.6,744.3,0.407,0.407,0,0,0,0.1,0.1);
	this.instance_119.alpha = 0;
	this.instance_119._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_119).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:0.5,regY:0.5,scaleX:0.11,scaleY:0.11,x:1022.2,y:639.7},30).to({_off:true},1).wait(166));

	// 4
	this.instance_120 = new lib._4();
	this.instance_120.parent = this;
	this.instance_120.setTransform(1396.2,902.1,0.338,0.338,0,0,0,0.3,0);
	this.instance_120.alpha = 0;
	this.instance_120._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_120).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:0.6,regY:1.6,scaleX:0.1,scaleY:0.1,x:1221.9,y:683.9},30).to({_off:true},1).wait(166));

	// 5
	this.instance_121 = new lib._5();
	this.instance_121.parent = this;
	this.instance_121.setTransform(1573,655.2,0.369,0.369,0,0,0,0.1,0.3);
	this.instance_121.alpha = 0;
	this.instance_121._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_121).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:1,regY:1,scaleX:0.1,scaleY:0.1,x:1271.3,y:614.7},30).to({_off:true},1).wait(166));

	// 6
	this.instance_122 = new lib._6();
	this.instance_122.parent = this;
	this.instance_122.setTransform(890.8,900.8,0.413,0.413,0,0,0,0.3,0.5);
	this.instance_122.alpha = 0;
	this.instance_122._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_122).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:0.5,regY:0.8,scaleX:0.12,scaleY:0.12,x:1080.5,y:683.5},30).to({_off:true},1).wait(166));

	// 7
	this.instance_123 = new lib._7();
	this.instance_123.parent = this;
	this.instance_123.setTransform(1597.3,391,0.521,0.521,0,0,0,0.2,0.2);
	this.instance_123.alpha = 0;
	this.instance_123._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_123).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:1.4,regY:0.7,scaleX:0.15,scaleY:0.15,x:1278.2,y:540.9},30).to({_off:true},1).wait(166));

	// 8
	this.instance_124 = new lib._8();
	this.instance_124.parent = this;
	this.instance_124.setTransform(675.6,495.7,0.299,0.299,0,0,0,0.1,0.4);
	this.instance_124.alpha = 0;
	this.instance_124._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_124).wait(2430).to({_off:false},0).to({alpha:1},8).to({regX:2.4,regY:2.4,scaleX:0.08,scaleY:0.08,x:1020.3,y:570.2},30).to({_off:true},1).wait(166));

	// 2009
	this.instance_125 = new lib._2009Y();
	this.instance_125.parent = this;
	this.instance_125.setTransform(1103.6,343,0.872,0.872,0,0,0,0.1,0.1);
	this.instance_125._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_125).wait(2348).to({_off:false},0).to({y:422.1},15).wait(35).to({y:336.1,alpha:0},30).to({_off:true},1).wait(206));

	// bg5
	this.instance_126 = new lib.bg5();
	this.instance_126.parent = this;
	this.instance_126.setTransform(961.5,542,1.463,1.463,0,0,0,0.1,0.1);
	this.instance_126._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_126).wait(2339).to({_off:false},0).wait(284).to({_off:true},1).wait(11));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1482802687019", id:"index_atlas_"},
		{src:"sounds/chp1_1_1953wav.mp3?1482802687630", id:"chp1_1_1953wav"},
		{src:"sounds/chp1_1_1981wav.mp3?1482802687630", id:"chp1_1_1981wav"},
		{src:"sounds/chp1_1_1986wav.mp3?1482802687630", id:"chp1_1_1986wav"},
		{src:"sounds/chp1_1_1995wav.mp3?1482802687630", id:"chp1_1_1995wav"},
		{src:"sounds/chp1_1_2009wav.mp3?1482802687630", id:"chp1_1_2009wav"}
	],
	preloads: []
};
